...
void DcmImageTransferFunction::clearReferencePoints()
{
...
QColor DcmImageTransferFunction::intermediateColor(const QColor &colorA, const QColor &colorB, double fraction)
{
    ...
    return QColor(intermediateNumber(colorA.red(), colorB.red(), fraction),
                  intermediateNumber(colorA.green(), colorB.green(), fraction),
                  intermediateNumber(colorA.blue(), colorB.blue(), fraction));
}

int DcmImageTransferFunction::intermediateNumber(int a, int b, double fraction)
{
    return a + qRound(qreal(b - a) * fraction);
}
